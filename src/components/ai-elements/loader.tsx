...
export const Loader = ({ className, size = 16, ...props }: LoaderProps) => (
  <div
    className={cn(
      "inline-flex animate-logo-spin items-center justify-center text-primary",
      className
    )}
    {...props}
  >
