...
export const SandboxTabsBar = ({
  ...
  <div
    className={cn(
      "flex w-full items-center border-border/60 border-t border-b",
      className
    )}
    {...props}
  />
...
export const SandboxTabsTrigger = ({
  ...
  <TabsTrigger
    className={cn(
      "rounded-none border-0 border-transparent border-b-2 px-4 py-2 font-medium text-muted-foreground text-sm transition-colors data-[state=active]:border-tint data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none",
      className
    )}
    {...props}
  />
