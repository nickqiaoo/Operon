...
import type { TokenizedCode } from "./shikiHighlighter";

// Re-export everything from sub-modules so existing imports keep working
export { highlightCode, createRawTokens } from "./shikiHighlighter";
export type { TokenizedCode } from "./shikiHighlighter";
...
} from "./CodeBlockLanguageSelector";
...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-xl border border-border/40 bg-background text-foreground",
      className
    )}
...
export const CodeBlockContent = ({
  ...
  const tokenized = useCodeHighlighting(code, language);

  return (
    <div className="relative overflow-auto code-scrollbar">
