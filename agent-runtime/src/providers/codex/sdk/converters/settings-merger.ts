...
export function buildConfigOverrides(settings: CodexAppServerSettings): Record<string, unknown> | undefined {
  ...
  if (settings.defaultPermissions !== undefined) {
    overrides.default_permissions = settings.defaultPermissions;
  }
...
export function mergeSettings(
  ...
  return {
    ...baseSettings,
    approvalMode: providerOptions.approvalMode ?? baseSettings.approvalMode,
    approvalsReviewer: providerOptions.approvalsReviewer ?? baseSettings.approvalsReviewer,
    sandboxMode: providerOptions.sandboxMode ?? baseSettings.sandboxMode,
    defaultPermissions: providerOptions.defaultPermissions ?? baseSettings.defaultPermissions,
    serviceTier: providerOptions.serviceTier ?? baseSettings.serviceTier,
