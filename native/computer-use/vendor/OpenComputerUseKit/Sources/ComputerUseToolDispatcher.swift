...
public final class ComputerUseToolDispatcher {
    ...
    /// Ends synthetic background focus for every target app.
    ...
    public func callTool(name: String, arguments: [String: Any]) throws -> ToolCallResult {
        ...
        case "get_app_state":
            return try service.getAppState(
                ...
                disableDiff: (arguments["disable_diff"] as? Bool) ?? false // [operon]
            )
        case "click":
        ...
        case "select_text": // [operon] not present upstream
    ...
    public func waitForUIToSettle(app: String) {
        service.waitForUIToSettle(app: app)
    }
